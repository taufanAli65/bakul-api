...
async def create_cart(
    ...
    cart_in = CartCreate(user_id=user_id, product_id=product_id, quantity=quantity)
    ...
    cart_in.price_at_time = product.price * quantity
    ...
    return create_response(
        ...
        data={
            ...
            "product_id": str(new_cart.product_id),
...
async def delete_cart_item(
    ...
    user_id = current_user.id_user
    cart_in = CartDelete(user_id=user_id, product_id=product_id)
...
async def update_cart_item(
    ...
    if cart.user_id != current_user.id_user:
        return create_response(
            success=False,
    ...
    return create_response(
        ...
        data={
            ...
            "product_id": str(updated_cart.product_id),
